...
Rscript -e "library(knitr); knit('vcf_report.Rmd', output='../../data/reports/BGI_all.md')" 01a_BGI1_set.txt.Q40.vcf.gz 01b_BGI2_set.txt.Q40.vcf.gz 03c_BGI3_set.txt.Q40.vcf.gz 01a_BGI1_set.txt.Q40.vcf.gz
