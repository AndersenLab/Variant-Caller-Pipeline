...
com = "cat ../ancillary/chr_ranges.txt | xargs -I {} -n 1 -P 12 --verbose sh -c 'samtools mpileup -d 100 -D -S -g -f ../reference/ce10/ce10.fa -r {} %s | bcftools view -O b - > ../vcf/raw.%s.{}.bcf'" % (' '.join(fasta_list),  outfile)
print com
os.system(com)
# awk '{ if ($6>=%s ||  $1 ~ /^#/) print}' - |
